...
//        ArthamticOperationsWithArrays.mulitplyThe2Matrix(array,array1);
        int array2[] = {1 , 2 ,5, 3 , 4  ,5};
        int arr[] = {1,2,3,4,5,6};
        int arr1[] = {1,2,7,5,9,10};
        int arr3[] = {1,0,3,0,4};
        int n = array2.length;
//        SubArray.printTwoParts(array2, n);
//        SubArray.findSumOfNNaturalNumber(10);
//        SubArray.findTheIntersectionofElement(arr1,arr);
        SubArray.findDublicate(array2);
        SubArray.findTheIndexValueOfParticularValue(array2);
        SubArray.moveZeroToEnd(arr3);
